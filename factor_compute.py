...
from barra_cne6.compute_factor_1 import CALFUNC, _calculate_su_simple, parallelcal,  lazyproperty, time_decorator, \
    get_signal_season_value, get_fill_vals, linear_interpolate, get_season_mean_value
from barra_cne6.compute_factor_2 import scaler
...
class Factor_Compute(CALFUNC):
    ...
    @lazyproperty
    def reverse_nm(self):
        # todo 我还需要下载一个所有股票的日成交笔数的因子，和成交金额一起，来计算日均每笔成交金额
        '''
