...
indicators = ["EP", "EPcut", "BP", "SP", "Sales_G_q", "Profit_G_q", "ROE_G_q", 'SUE', ]
...
def generate_new_factor_table():
    save_path = r'D:\pythoncode\IndexEnhancement\因子预处理模块\因子'
    factor_path = r'D:\pythoncode\IndexEnhancement\barra_cne6\factor_data'
    ...
    z.fill_pct_monthly()
    z.create_factor_file(datetime(2020, 5, 29))
    z.create_factor_file(datetime(2020, 6, 30))
